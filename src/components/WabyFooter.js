...
export const WabyFooter = ({ nocturnMode }) => {
    return (
        <div className={ nocturnMode ?  ' wf' :  '  wf-nocturn' }>

        
        
            <div >
                <svg className='__portfolio_waby-svg' viewBox="0 0 1440 74" preserveAspectRatio='none' >
                    <path 
